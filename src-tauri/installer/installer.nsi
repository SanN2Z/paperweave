; Paperweave adaptation of Tauri CLI 2.11.4 installer.nsi.
; Upstream MIT / Apache-2.0; see README.md in this directory.
Unicode true
...
!define MUI_UNCONFIRMPAGE_TEXT_TOP "$(paperweaveKeepResearch)"
...
Section Uninstall
  ...
  ; Research data is user-owned. Uninstall never removes application data or vaults.
